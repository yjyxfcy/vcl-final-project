...
target("final")
    set_kind("binary")
    add_deps("lab-common")
    add_headerfiles("src/VCX/Labs/final_hw/*.h")
    add_headerfiles("src/VCX/Labs/final_hw*.hpp")
    add_files      ("src/VCX/Labs/final_hw/*.cpp")
    after_build(function (target)
        os.cp("src/VCX/Labs/final_hw/shaders/*", path.join(target:targetdir(), "assets", "shaders"))
    end)
    after_install(function (target)
        os.cp("src/VCX/Labs/final_hw/shaders/*", path.join(target:installdir(), "bin", "assets", "shaders"))
    end)